...
sysfonts::font_add(
  family = params$font,
  regular = file.path(
    getwd(), "inst", "resources", "fonts",
    paste0(params$font, "-", "Regular", ".", params$font_ext)
  ),
  bold = file.path(
    getwd(), "inst", "resources", "fonts",
    paste0(params$font, "-", "Bold", ".", params$font_ext)
  ),
  italic = file.path(
    getwd(), "inst", "resources", "fonts",
    paste0(params$font, "-", "Italic", ".", params$font_ext)
  ),
  bolditalic = file.path(
    getwd(), "inst", "resources", "fonts",
    paste0(params$font, "-", "BoldItalic", ".", params$font_ext)
  )
)
